let students = ["Mahmoud","Hannan","Abdulkadir","Deeqa"] //create list string
let studentAges = [30,25,27,28] //create list number


// console.log(studentAges)
// console.log(students)
// console.log(students[0])
// students[2] = "Fatoma" //replace list using index
// students.push("Abdulghani") //add to the end of the array string
...
console.log(students)
console.log(students.sort()) //sort the list alphabetically
console.log(students.reverse()) // sort the list in reverse order
